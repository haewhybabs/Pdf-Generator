...
<body>
	<div class="coverpage">
		<img src="<?php echo "http://" . $_SERVER['SERVER_NAME']; ?>/pdf_generator/generate_pdf/assets/pdf_gen/CoverPage.jpg">

	</div>

    <?php for($i=0; $i<$total; $i+=30):?>
	<div class="page1" style="page-break-before: always;">
		<img src="<?php echo "http://" . $_SERVER['SERVER_NAME']; ?>/pdf_generator/generate_pdf/assets/pdf_gen/InnerRight.jpg">
	...
	<div class="page2" style="page-break-before: always;">
		<img src="<?php echo "http://" . $_SERVER['SERVER_NAME']; ?>/pdf_generator/generate_pdf/assets/pdf_gen/InnerLeft.jpg">
	...
	<div class="backpage" style="page-break-before: always;">
		<img src="<?php echo "http://" . $_SERVER['SERVER_NAME']; ?>/pdf_generator/generate_pdf/assets/pdf_gen/BackPage.jpg">
